...
5. **产品行为以这些契约为准**: {引用 §7 和 output/requirements.md；具体验证方法由 TDD Master 生成}

## 11. 关键决策

> 从 PRD 详细版同步，不重新推导。只列已通过关键决策闸门的产品/架构决定；完整讨论见 debate-log.md。
...
output/PRD详细版.md 是完整版（{N} 行），本文是浓缩版（约 500 行）；产品可观察行为与稳定 ID 以 output/requirements.md 为准，测试方法由后续 TDD Master 定义。若三者冲突，停止实现并回到 PRD 修订。
