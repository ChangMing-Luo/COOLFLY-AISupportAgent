...
- **界面语言 = 简体中文**（内部工具，区别于 App 用户侧英文）；不违反 F07 约束——知识条目内容本身仍为英文并带语言字段（§4.1），管理台界面文案与条目内容分离，本节文案定稿即中文界面文案唯一落点。
...
F09 无 App 用户侧旅程；为 §2.3 旅程 A/C 提供知识供给侧支撑（条目质量与问题标签召回），使用旅程见 US-F09-01/02/03（§2.4）。
...
| FR-F01–FR-F09 | 9（组级） | §5.2–§5.10 各小节标题 | §2.4 全部 22 条 US 的「由 FR-F0x 实现」均指向已定义的组级 FR；只增补不重排（R2-裁决 5；FR-F09 为 08-04-2026 增补） |
| US-F01-01 … US-F09-03 | 22（F01×7、F02×3、F03×2、F04×2、F05×1、F06×2、F08×2、F09×3；F07 无 US，已在 §2.4 显式声明） | §2.4 | 每条 US 均落 FR；F05/F06 间接角色 US 与 §10 AC-M-09/M-10 对应；F09 三条 US（角色=知识库内容运营，§2.1 已增补该直接角色）与 AC-M-13–15/AC-E-13–14 对应 |
| AC-M | 15（AC-M-01–15） | §10.1 | 引用的文案（§5）、维度定义（§4）、机制（§3）均有落点；AC-M-13–15（F09，08-04-2026 增补）↔§5.10 发布门禁/审核队列/无人审不生效、§4.1 审核信息 |
| AC-E | 14（AC-E-01–14） | §10.2 | AC-E-02↔§3.3 连续计数；AC-E-03↔§3.1 关键词规则（清单 v1 §12.7，R5-T1）；AC-E-06↔§5.2 超范围专属文案（R5-S3）；AC-E-07↔§5.4 缓冲系数定数；AC-E-09↔§5.4 摘要降级；AC-E-11↔§5.9 降级行为；AC-E-13/14（F09，08-04-2026 增补）↔§5.10 AI 建议态与发布门禁，均闭合 |
